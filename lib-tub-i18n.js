...
const I18N = {
  ...
  'Any previous experience with custom baths?': ['之前有客制浴缸的经验吗？', 'เคยมีประสบการณ์กับอ่างอาบน้ำสั่งทำมาก่อนไหม?', '之前有客製浴缸的經驗嗎？'],
  'First time': ['第一次', 'ครั้งแรก', '第一次'],
  'Ordered custom before': ['之前订过客制款', 'เคยสั่งทำแบบกำหนดเองมาก่อน', '之前訂過客製款'],
